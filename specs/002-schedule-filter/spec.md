...
- **FR-009**: Tasks with an assigned date MUST display the date in a human-readable format (e.g., "Apr 29, 2026") beneath the task text. Users MUST be able to tap the date subtitle to re-open the date picker and change the date. Undated tasks MUST display a calendar icon that opens the picker to assign a date
